                    ...
                    <div class="text-95 text-secondary-d3">
                        ...
                        @foreach ($orders_detail as $product)
                            <div class="row mb-2 mb-sm-0 py-25">
                                ...
                                <div class="d-none d-sm-block col-2 text-95">{{ number_format($product->giatien != 0 ? $product->giatien : $product->giakhuyenmai,-3,',',',') }} VND</div>
                                <div class="col-2 text-secondary-d2">{{ number_format($product->giatien != 0 ? $product->giatien : $product->giakhuyenmai * $product->soluong, -3, ',', ',') }} VND</div>
                            </div>
                            @php
                                $count++;
                            @endphp
