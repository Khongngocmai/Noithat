    ...
    <div class="col-lg-12">
        <form action="{{ route('product.edit',['id' => $product->id_sp]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" id="start_date_container">
                ...
                <input type="date" class="form-control" id="start_date" name="start_date" min="{{ date('Y-m-d') }}" value="{{ $product->thoigianbatdau != null ? $product->thoigianbatdau : '' }}" required>
            </div>
            <div class="form-group" id="end_date_container">
                <label for="end_date">Thời gian kết thúc: <span class="text-danger">*</span></label>
                <input type="date" class="form-control" id="end_date" name="end_date" min="{{ date('Y-m-d') }}" value="{{ $product->thoigianketthuc != null ? $product->thoigianketthuc : '' }}" required>
            </div>
            <div class="form-group">
